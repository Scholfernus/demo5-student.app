    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <div class="container-fluid">
                <form method="post" action='<c:url value="addTask.jsp"/>'>
                    <!-- Content Row -->
                    <div class="row">
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-10">
                                            <select class="form-control" name="studentModel.id">
                                                <option hidden>Wybierz${taskModel.studentModel.firstName} ${taskModel.studentModel.lastName}</option>
                                    ...
                                    <input type="hidden" name="creationDate"
                                           value="<fmt:formatDate pattern= "yyy-MM-dd" value="${taskModel.creationDate}"/>">

                                    <div class="form-group row">
                                        <label class="col-2 col-form-label">Deadline</label>
                                        <div class="col-10">
                                            <input class="form-control" type="date" name="deadline" max="2030-12-31"
                                                   min="<fmt:formatDate pattern= "yyy-MM-dd" value="${now}"/>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-2">
                                            <label class="radio-inline"><input type="radio" value="success"
                                                                               name="color" <c:if test = "${taskModel.color eq 'success'}">checked</c:if>>
                                        ...
                                        <div class="col-sm-2">
                                            <label class="radio-inline"><input type="radio" value="secondary"
                                                                               name="color" <c:if test = "${taskModel.color eq 'secondary'}">checked</c:if>>
                                                <i class="btn btn-secondary btn-circle btn-sm"></i> poziom mid</label>
                                        </div>
                                        <div class="col-sm-2">
                                            <label class="radio-inline"><input type="radio" value="primary"
                                                                               name="color" <c:if test = "${taskModel.color eq 'primary'}">checked</c:if>>
