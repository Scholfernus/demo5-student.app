                                    ...
                                    <div class="card mb-4 py-3 border-left-${task.color}">
                                        <div class="card-body">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">${task.studentModel.firstName} ${task.studentModel.lastName}
                                                <strong>Dodano:</strong> <fmt:formatDate pattern = "yyyy-MM-dd" value = "${task.creationDate}" /> | <strong>Deadline:</strong>
                                                <fmt:formatDate pattern = "yyyy-MM-dd" value = "${task.deadline}" /></div>
                                                ${task.description}
                                        </div>
                                    </div>
                                </a>
